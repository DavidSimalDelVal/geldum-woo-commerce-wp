<?php
/*
Copyright (c) 2018 Geldum Project
*/
    ...
    class Cryptonote
    {
        ...
        /*
         * Create a valid base58 encoded Geldum address from public keys
         *
         * @param string Public spend key
         * @param string Public view key
         *
         * @return string Base58 encoded Geldum address
         */
	...
	/*
         * Decode a base58 encoded Geldum address
         *
         * @param string A base58 encoded Geldum address
         *
	...
	public function decode_address($address)
        ...
        /*
         * Generate a Geldum address from seed
         *
         * @param string Hex string to use as seed
         *
         * @return string A base58 encoded Geldum address
         */
